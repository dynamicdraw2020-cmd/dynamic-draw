...
interface LogRow { id: string; created_at: string; action: string; target_table: string | null; target_id: string | null; ip_address: string; entry_hash: string; details?: unknown; profiles?: { display_name?: string; email?: string } | Array<{ display_name?: string; email?: string }>; }
