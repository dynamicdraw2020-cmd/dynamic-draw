...
import { getAdminProfileSnapshot } from "@/lib/data";
...
export default async function AdminOperationsPage() {
  ...
  const [profiles, results, tickets, currencyLogs, exchanges, attendances, blacklists, inquiries] = await Promise.all([
  ...
  const approvedMembers = profiles.filter((profile) => profile.status === "APPROVED").length;
