...
export default async function AdminRafflesPage() {
  ...
  return <><div className="admin-toolbar"><div><h1>전체 회원 추첨</h1><p className="text-muted">승인된 전체 회원 중 1명을 인형뽑기식 연출로 추첨합니다.</p></div></div><RaffleManager raffles={raffles} adminRole={admin.role} /></>;
}
