...
export default async function AdminRafflesPage() {
  ...
  return <><div className="admin-toolbar"><div><h1>추첨이벤트</h1><p className="text-muted">등급 조건을 설정하고 가챠형 연출로 공개 추첨을 진행합니다.</p></div></div><RaffleManager raffles={raffles} adminRole={admin.role} memberTiers={(tiersResult.data ?? []) as never[]} /></>;
}
