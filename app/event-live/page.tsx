...
export default async function EventLivePage() {
  ...
  return <main className="page event-live-page dynamic-ink-page"><div className="container grid">
    <section className="page-heading live-heading"><span className="section-kicker">EVENT LIVE</span><h1>Dynamic D 라이브 송출 화면</h1><p>OBS 브라우저 소스, 디스코드 화면 공유, 모바일 라이브에 맞춘 이벤트용 화면입니다.</p></section>
