-- Dynamic Draw one-time Supabase setup v1.0.3
-- Run once in a new Supabase project. Safe to re-run because policies are recreated idempotently.
...
-- pgcrypto 설치 스키마가 달라도 항상 동작하도록 사용하는 내부 래퍼입니다.
